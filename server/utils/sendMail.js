...
export const passwordResetTemplate = (url, linkTag) => {
  return ` 
    <!Doctype html>
    <html lang="en-US">
    <head>
            ...
            <tr>
                <td>
                    <table style="background-color: #f2f3f8; max-width:670px;  margin:0 auto;" width="100%" border="0"
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>www.ngnc.online</strong></p>
                            </td>
                        </tr>
                        <tr>
                            <td style="height:80px;">&nbsp;</td>
...
export const successResetTemplate = (url) => {
  return ` 
    <!Doctype html>
    <html lang="en-US">
    <head>
